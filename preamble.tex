\usepackage{float,multicol,amsfonts,epsfig,framed,calc,txfonts}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Create new counter to save enumi for later %
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newcounter{enumigrab}
...
\newcommand{\sage}{\includegraphics[height=12pt]{sageLogo}}
...
\textit{\LARGE\color{MidnightBlue} Experiences in Mathematics}\hspace{\rtab}\phantom{|} \\[1.5\baselineskip]
