...
%%%%%%%%%%%%%%%%%%%%%%%%
\newcommand{\textidxthm}[1]{\textbf{\textit{#1}}}
\newcommand{\textidxkey}[1]{\textbf{#1}}
\newcommand{\textidxdig}[1]{\textit{#1}}
...
\newcommand{\geogebra}{\href{https://www.geogebra.org/calculator}{\includegraphics[height=12pt]{geogebraLogo}}}
...
\newcommand{\haspartwithsolution}{\enspace{\color{gray}${[\mathbb{S}]}$}-}
%\newcommand{\hasananswer}{{\color{blue}${}^{[\mathbb{A}]}$}}
\newcommand{\hasananswer}{\enspace{\color{blue}${[\mathbb{A}]}$}-}
\newcommand{\haspartwithanswer}{\enspace{\color{gray}${[\mathbb{A}]}$}-}
...
\textit{\LARGE\color{MidnightBlue} Explorations in Mathematics}\hspace{\rtab}\phantom{|} \\[.4\baselineskip]
{\LARGE\color{MidnightBlue} $2^{nd}$ edition}\hspace{\rtab}\phantom{|} \\[3\baselineskip]
